...
\begin{figure}
  \begin{subfigure}{0.5\textwidth}
    ...
    \includegraphics[scale=0.32]{assets/wines-ontology-onto-pop-temp-var-exp.pdf}
  \end{subfigure}
  \hspace{0.2cm}
  \begin{subfigure}{0.5\textwidth}
    \centering
    ...
    \includegraphics[scale=0.32]{assets/case-uco-owl-trafficking-onto-pop-temp-var-exp.pdf}
  \end{subfigure}
