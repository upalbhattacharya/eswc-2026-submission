...
\usepackage[commandnameprefix=always,todonotes={textsize=footnotesize}]{final} % Add 'final' for submission
...
individuals but higher depth and breadth. \chadded[id=UB,
comment={\textbf{ISWC 5, 8, 16}: Addressing ISWC '25 comments about using
larger ontologies and about concepts with more than one parent}]{All three
...
\chdeleted[id=UB, comment={\textbf{CASE}: Present CASE as the hardest after presenting the lexical variability information}]{As a result, the CASE ontology may pose a harder scenario for the LLMs.}
...
\chadded[id=UB, comment={\textbf{CASE}: Lexical similarity explanation. I think it highlights why CASE is hard using mAP@D quite well now.}]{
...
\chadded[id=UB, comment={\textbf{ISWC 6}: Defintions of mAP@1 and mAP@D}]{%
