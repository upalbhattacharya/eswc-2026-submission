...
\item The emergent abilities of LLMs grows with \textbf{model size}
  ...
  larger LLMs for ontology learning tasks. While LLMs are accurate on topics
  of greater popularity, they are known to struggle and hallucinate with
  long-tail knowledge \cite{kandpal2023LargeLanguageModels}. In such
  situations, fine-tuning is known to outperform in-context learning
