...
concepts. $\text{mAP@1}$ provides an inflated view of the capabilities of LLMs
to infer concept assertions whereas $\text{mAP@D}$ provides a more
comprehensive view of their performance reliability. We observed that $83$
out of the $161$ individuals ($51.5\%$) for the Wines Ontology, $94$ of the
$131$ individuals ($71.7\%$) in the CASE Ontology and, $17$ out of the $68$
individuals ($25\%$) for the Astronomy Ontology utilize the name of their
directly-asserted concept in their labels.  While ontology population does not
