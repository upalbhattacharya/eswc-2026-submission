...
amount of their pre-training that relates to it
\cite{kandpal2023LargeLanguageModels}. Variation in entity label naming
highlights the parity between the ontological semantics of the entities and
the learnt lexical semantics of LLMs for their labels. This parity is crucial
for effective ontology population. As most LLMs employ subword tokenization
like Byte Pair Encoding (BPE) \citep{sennrich2016NeuralMachineTranslation} for
...
learning task, we conduct experiments for ontology population and investigate
...
hierarchies where every concept (except the top concept) has at most a single
parent. We wish to expand the considered set of ontologies to include larger
