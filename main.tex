...
\cite{davies1979ClusterSeparationMeasure}between the embeddings of
concepts and individuals for each ontology and provides the first indication of semantic
