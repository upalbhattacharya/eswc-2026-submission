...
separation. We measure entity semantic separation through centroid distance
 of embeddings of concepts and labels and overall entity semantic separation
 using the Davies-Bouldin Index (DBI)
 \cite{davies1979ClusterSeparationMeasure} (Table \ref{tab:entity-label-separation}).
We observe that the normalized centroid distance between concepts and
individuals 
