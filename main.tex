...
The scope of an ontology defines the level of specificity of its entities.
Ontologies can be upper-level or top ontologies that defined abstractions
enabling integration of heterogeneous knowledge across different domains
\citep{mascardi2007ComparisonUpperOntologies} or of particular domains itself
e.g. genetics for the Gene Ontology \cite{ashburner2000GeneOntologyTool}.
