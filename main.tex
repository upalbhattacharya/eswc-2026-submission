...
\item While LLMs are capable of performing several tasks `as-is',
  ...
  are in the long-tail of an LLM's pre-training data. Fine-tuning approaches
  for ontology learning demonstrate the requirement of domain-specific
  ontology data availability for LLM-supported ontology learning.
% RAG
