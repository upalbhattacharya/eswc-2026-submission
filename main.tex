...
\item LLMs are capable of handling a wide variety of tasks. However, they do
  ...
  and relations with several tasks requiring multi-hop reasoning LLM-supported
  ontology population requires an LLM to understand and reason over concepts,
  their hierarchy and assign new instances. Investigation of performance of
