...
only provided with concept labels.  In addition, as discussed in more detail
in Sections \ref{subsec:method-ontology-variability} and \ref{sec:results},
the nature of individual labels across ontologies leads us to believe that
evaluating the ability of LLMs on ontology population using only
directly-asserted concepts may provide inflated performance indicators due to
lexical matching of entity labels.}
