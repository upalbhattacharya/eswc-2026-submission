...
individual terms $t \in T$ associated with that concept.

\begin{equation}
  CR(c) = \frac{\big|\{t \in T; c \in \{y_i\}_{t}; y_{D-d+1} = c\}\big|}{\big|\{t \in T; c \in \{y_i\}_{i=1}_t\}\big|}
\end{equation}
...
concept with their CR. This highlights that structural metrics of concepts do
not influence the ability of LLMs to perform ontology population. This is
further reinforced by comparing the size of the ontologies and their exhibited
performance. The largest Astronom
