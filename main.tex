...
To investigate the extent string similarity can be leveraged by LLM for
ontology population, we compute the compute the Levenshtein distance
\cite{levenshtein1966BinaryCodesCapable} between the labels of individuals and
the two groups outlined previously in \Section \ref{subsec:experiment-ontology-factors}
