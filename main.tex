...
\item \chreplaced[id=UB, comment={Including lexical similarity}]{LLMs are
    susceptible to resorting to lexical matching when they cannot rely on
    their interpretation of entity labels.}{Disparity between an LLM's
    interpretation of concepts and instances has a detrimental effect on the
    performance of LLM-driven ontology population.}
