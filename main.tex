...
\item LLMs are capable of performing ontology population under zero-shot
  prompting. Adding examples with few-shot prompting significantly improves
  performance with the largest benefits obtained with three or four examples.
