...
draws inspiration from the Ontology Layer Cake
...
and classes define what is true in an ontology. Axioms are logical
abstractions of the behaviour observed by the entities of an ontology in the
