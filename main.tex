...
topics). Variation in entity label naming highlights the parity between the
ontological semantics of the entities and the learnt lexical semantics of LLMs
for their labels. This parity is crucial for effective ontology learning. As
...
string edit-distance-based senses for performing ontology learning.
