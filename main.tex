...
\item While LLMs are capable of performing several tasks `as-is',
  ...
  As mentioned previously, domain and task-specific \textbf{fine-tuning}
  provides performance improvements when prompting-based approaches are
  insufficient. When working with information in the long-tail, fine-tuning
  allows LLMs to adapt better than with in-context learning. Fine-tuning
  allows LLMs to carry out ontology learning over ontologies that are in the
  long-tail. Fine-tuning approaches 
% RAG
