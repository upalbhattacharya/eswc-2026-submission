...
ontological semantics of the entities and the learnt lexical semantics of
LLMs. This parity is crucial for effective ontology population. As most LLMs
employ subword tokenization like Byte Pair Encoding (BPE)
...
primarily with indentifying instances for concepts, it requires understanding
the granularity of the taxonomy to identify the correct concept for a new
individual assertion. LLM-supported ontology population therefore investigates
whether LLMs are capable of understanding the taxonomy of an ontology and how
new individuals are to be placed within that taxonomy.
...
relations and attribute relation properties comprise a large part of
...
attribute value of `WineColor' that is associated with different classes with
the relation `hasColor'. Analysing whether LLMs are susceptible to such
pitfalls when populating ontologies can provide insight into their ability to
accurately apply a sense distinction in the context of ontologies.
