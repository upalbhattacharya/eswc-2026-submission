...
\item Functional measures test the intended use of an ontology
  ...
  coverage and clarity \citep{hlomani2014ApproachesMethodsMetrics} provide
  measures of the functional competency of an ontology in modelling its
  domain.While these measures are approximations of the effectiveness of the
  modelling of the domain, they can help highlight whether functional adequacy
  of an ontology influences the ability of an LLM to identify its assertions.
