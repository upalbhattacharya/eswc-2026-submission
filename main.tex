...
population as the first learning task to investigate for its
simplicity. Despite being simple, ontology population requires an LLM to
``understand'' concepts and instances in an ontology to make new
assertions. LLM-supported ontology population helps us investigate the degree
of awareness LLMs posses of ontology assertion relations and of the entities
themselves.
