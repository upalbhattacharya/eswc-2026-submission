...
\begin{abstract}
  ...
  prompting with conventional LLMs can achieve similar performance.
  LLMs are fairly insensitive to temperature
  ...
  whereas the results of smaller LLMs have much larger variability. Our study over
