...
fairly small spreads in $mAP@D$ values across all temperature values and both
ontologies. In contrast, there is more variability in the $mAP@D$ scores for
Llama3-8B.
...
deal of variation at each temperature value. $\text{mAP@D}$ performance
variation marginally increases with temperature in GPT-4o but performance on
Llama3-8B is equally variable at all temperatures. There is an observed
degradation in performance with increase in temperature in GPT-4o, with the
highest performance observed at the lowest temperature
