...
embeddings of concepts and labels and overall entity semantic separation using
the Davies-Bouldin Index (DBI) \cite{davies1979ClusterSeparationMeasure}
(Table \ref{tab:entity-label-separation}). We observe that the normalized
centroid distance between concept and individual clusters for the CASE
Ontology to be twice as large as the other two ontologies (larger values
indicate greater inter cluster separation).
