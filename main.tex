...
\subsubsection{Domain Context:}
We experiment with four types of domain contextualization: 1) Generic: The LLM
is only asked to perform a generic task e.g. ranked retrieval.  2) Ontology:
The LLM is defined as an expert in ontologies.  3) Topic of an ontology: The
LLM is defined as an expert in the topic of an ontology
e.g. \verb|`You are a wine expert'| for the Wines Ontology
\cite{noy2001OntologyDevelopment101} 4) Ontology and Topic: The LLM is defined
as an expert in ontologies and an expert in the topic.\footnote{Examples of
  the prompt templates can be found at our
