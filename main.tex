...
experiments with Llama3-8B. GPT-4o's results are fairly consistent across all runs, which is observable as
fairly small spreads in $mAP@D$ values across all temperature values and
