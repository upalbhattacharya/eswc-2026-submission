...
\ref{tab:entity-label-separation} (G1 and G2). Group 1(G1) disparity exhibits the
lexical similarity between an individual label and its directly-asserted
...
concept. is highest for the Wines ontology and lowest for
