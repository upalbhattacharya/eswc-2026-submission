...
between CR and two structural metrics: depth and dispersion of concepts. We
consider the average correlation \cite{corey1998AveragingCorrelationsExpected}
across all 96 experiments conducted for each ontology by
