...
\ref{tab:entity-label-separation} (G1 and G2). G1 disparity is highest for the Wines
ontology and lowest for the CASE ontology. LLMs cannot resort to lexical
...
ontologies. Group 2 disparity clearly highlights that lexical matching is
