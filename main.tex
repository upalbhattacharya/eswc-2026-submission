...
Dispersion evaluates semantic separability as well for closely related sibling
entities. We investigate correlations between LLM-supported ontology
population performance and structure. In particular, we investigate if deeper,
broader or dispersed ontologies (and concepts) represent more complex
situations for LLMs to perform ontology population.
