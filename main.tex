...
performing ontology population when provided with simple labels. Performance
drops significantly for the CASE and Astronomy ontologies in the zero-shot
setting compared to $\text{mAP@1}$ but few-shot context examples largely help
alleviate the issue.
