...
\subsubsection{Type of LLM:}
\label{subsubsec:llm-factor-type}

\subsubsection{Type of task:}
...
\chadded[id=UB, comment={\textbf{ISWC 2}: Added citation to clarify ISWC '25
  reviewer confusion about what and `extension`
  is.}]{\cite{etzioni2004WebScaleInformation}} of $c_1$ (i.e. set of asserted
individuals)
