...
label suggests that LLMs might be able to infer the directly-asserted concepts from lexical matching but cannot infer hierarchies.The semantic separation and lexical disparty between the two entity types
