...
entities.
Through cluster separation analysis of the embeddings, we analyze if the LLM representations: 1) associate related concepts of different ontologies
together and, 2) if their representations can associate individuals of an
ontology closely with its concepts.
LLM embeddings are indicators of the semantic
`understanding' LLMs develop of words. 
