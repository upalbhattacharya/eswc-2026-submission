...
population difficult for LLMs. The performance in Table
\ref{tab:results} supports our hypothesis with the CASE Ontology performance
being significantly lower than the other two ontologies in the zero-shot
scenario and when using one or two examples for few-shot prompting. Beyond
that, the provision of more examples in few-shot counters the effects of this
entity semantic separation. 
