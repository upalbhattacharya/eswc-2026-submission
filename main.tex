...
representations: 2) if their representations can associate individuals of an
ontology closely with its concepts. 1) are capable of capturing label domain
similarity by having higher similarity between entities from the same ontology
and, 2) if their representations view concepts and individuals as
significantly distinct

We supplement the analysis of
entity labels by investigating the lexical matching between concept and
individuals. This supplementary analysis aims to assess whether LLMs resort to
