...
ontologies.
\begin{itemize}
  \item Structural metrics evaluate the structural complexity of an ontology
    in terms of its size, breadth, depth and dispersion
    \citep{hlomani2014ApproachesMethodsMetrics}. The structure of an ontology
    highlights the semantics of the underlying domain or scope. The size of an
    ontology in terms of its entity count is an indicator of the enormity of
    its scope. Ontologies with large depth reflect domains with knowledge of
high granularity while those with greater breadth and complexity of an
ontology
  \item Functional
\end{itemize}
