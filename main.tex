...
% Dataset Choice
\begin{itemize}
\item The Wines Ontology \cite{noy2001OntologyDevelopment101} is a structurally
simple and well-known ontology concerning wines
\end{itemize}
; it is small, structurally simple, and represents a relatively
