...
directly-asserted concept in their labels. In such situations, lexical
matching is sufficient for direct assertion. Thus, $\text{mAP@1}$ provides an
inflated view of the capabilities of LLMs to infer concept assertions whereas
