...
(Figure \ref{fig:few-shot}). $\text{mAP@1}$ provides an inflated view of the
...
ontology population does not concern itself directly with taxonomies, analysis
using $\text{mAP@D}$ provides a more ontologically grounded evaluation
approach. It highlights that LLMs on their own, may not possess good
