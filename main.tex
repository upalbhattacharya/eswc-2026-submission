...
\ref{tab:entity-label-separation}). Centroid distance is an indicator of inter
cluster separation while the DBI metric is an internal clustering evaluation
...
better). The DBI for the CASE Ontology is much
lower than the other two ontologies. Table \ref{tab:entity-label-separation}
 We observe that the normalized centroid
