...
GPT-4o is fairly consistent across all temperature settings on both
ontologies. In contrast, Llama3-8B exhibits a great deal of variation at each
temperature value. $\text{mAP@D}$ performance variation marginally increases
with termperature in GPT-4o but the same is not observed in Llama3-8B.

Surprisingly enough, neither higher
temperature settings nor ontology differences bring about peaks in variance
(although, more exploration of this issue is required).  Looking at the
