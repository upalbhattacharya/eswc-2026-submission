...
\item The CASE Ontology \cite{casey2017AdvancingCoordinatedCyber} is a larger,
  ...
  website\footnote{\url{https://caseontology.org/examples/}} add individuals
  to its concepts using the Owl Trafficking example provided on the CASE
  Ontology website As the CASE Ontology is built on top of the UCO Ontology
