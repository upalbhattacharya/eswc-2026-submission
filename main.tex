...
\begin{itemize}
\item Structural complexity of ontologies does not seem to affect an LLM's
  ability to perform ontology population. Ontologies of greater depth may be
  harder to predict hierarchies for. However, we acknowledge that despite
  their differences, all three analyzed ontologies can be categorized as
  structurally simple.}
