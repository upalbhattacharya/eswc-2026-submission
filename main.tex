...
smallest ontology: Wines, has the largest number of individuals. The three
ontologies represent a very small, a medium and a relatively large ontology to
test for ontology population. However, in compared to larger ontologies like
DBPedia \cite{auer2007DbpediaNucleusWeb}, all three are relatively small and
structurally simple. The Astronomy Ontology has the largest breadth
...
granularity of the domain. Test
\end{itemize}
