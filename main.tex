...
performing ontology population when provided with simple labels.  Larger
and/or commercial models outperforming smaller LLMs. $\text{mAP@D}$
performance drops significantly for the CASE and Astronomy ontologies in the
zero-shot setting compared to $\text{mAP@1}$ but few-shot context examples
largely help alleviate the issue.
